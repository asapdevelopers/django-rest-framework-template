...
class ImageThumbnail(object):
    ...
    def create(cls, data):
        ...
        Returns the results a temporary file that might or might not be sent to disk and the caller is responsable of closing it.
        Also returns the thumbnail picture extension (without the "." )
